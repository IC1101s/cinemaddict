...
const createCommentMarkup = (comments) => {	
  return comments.map((it) => {
  	const clearText = (0,he__WEBPACK_IMPORTED_MODULE_2__.encode)(it.text); 
		const dateHumanReadable = (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_1__.formatDateHumanReadable)(it.date);
...
class FilmDetails extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__.default {
  ...
  _parseFormData(formData) {
	   return {
	    ...
	    date: (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_1__.formatDateHumanReadable)(`now`),
...
class FilterController {
    ...
    const filters = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType).map((filterType) => {
      return {
        name: filterType,
        count: (0,_utils_filter_js__WEBPACK_IMPORTED_MODULE_3__.getFilmsByFilter)(allFilms, filterType).length,
    ...
    this._filterComponent = new _components_filter_js__WEBPACK_IMPORTED_MODULE_0__.default(filters, this._activeFilterType);
    this._filterComponent.setFilterChangeHandler(this._onFilterChange);

    if (oldComponent) {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this._filterComponent, oldComponent);
    } else {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(container, this._filterComponent);
    }
	}
...
/* harmony import */ var _models_comments_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/comments.js */ "./src/models/comments.js");
...
class MovieController {
  constructor(container, onDataChange, onViewChange) {
    ...
    this._commentsModel = new _models_comments_js__WEBPACK_IMPORTED_MODULE_2__.default();
  ...
  render(film) {  
    ...
    this._filmComponent.setFavoritesButtonClickHandler((evt) => {
      ...
      this._onDataChange(this, film, Object.assign({}, film, {
		...
		if (oldFilmComponent) {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_3__.replace)(this._filmComponent, oldFilmComponent);
    } else {    
    	(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(this._container, this._filmComponent);
    }

    if (this._mode === Mode.DETAILS_OPEN && oldFilmComponent) {
      this._countPixels = this._filmDetails.getElement().scrollTop;
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(this._filmDetails);
  ...
  _renderFilmDetails(film) {
    ...
    this._filmDetails = new _components_film_details_js__WEBPACK_IMPORTED_MODULE_1__.default(film, comments);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(footer, this._filmDetails, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.AFTEREND);
  ...
  destroy() {
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(this._filmComponent);
...
const renderFilms = (filmsListContainer, films, onDataChange, onViewChange) => {
	return films.map((film) => {
		const movieController = new _movie_js__WEBPACK_IMPORTED_MODULE_0__.default(filmsListContainer, onDataChange, onViewChange);
...
const getSortedFilms = (films, sortType, from, to) => {
  ...
  switch (sortType) {	
    ...
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_4__.SortType.RATING:
      ...
      break;
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_4__.SortType.DEFAULT:
...
class PageController {
	...
	render() {
	  ...
	  if (isAllFilmsWatched) {
	  	(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_5__.remove)(this._sortComponent);
	    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(container, this._noFilmsComponent);
	    return;
	  }		

		(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(container, this._filmsListComponent);
  ...
  _updateFilms(count) {
	...
	_renderShowMoreButton() {
		(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_5__.remove)(this._showMoreButtonComponent);
    ...
    const filmsListElement = this._filmsListComponent.getElement();
		...
		(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_5__.render)(filmsListElement, this._showMoreButtonComponent);
...
const generateComment = () => {
  return {
    ...
    date: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayItem)(date),
    emoji: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayItem)(emojis),
  };
};
...
const generateFilm = () => {
  const dueDate = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(datesFilms);
  const genre = genresFilms[(0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomIntegerNumber)(0, genresFilms.length - 1)];
  const copyGenresFilms = genresFilms.slice();
  const deleteGenre = copyGenresFilms.splice(copyGenresFilms.indexOf(genre, 0), 1);
  const genres = [genre].concat((0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayLength)(copyGenresFilms)).join(` `);
  const commentsCount = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomIntegerNumber)(0, 5);

  return {
    id: String(new Date() + Math.random()),
  	name: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(namesFilms),
    rating: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(ratingsFilms).toFixed(1),
    duration: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(durationsFilms),
    poster: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(postersFilms),
    description: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(descriptionsFilms),  
    director: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(directorsFilms), 
    country: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(countrysFilms),
    age: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayItem)(agesFilms),
    writers: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayLength2)(writersFilms).join(`, `),
    actors: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomArrayLength2)(actorsFilms).join(`, `), 
    year: (0,_utils_date_js__WEBPACK_IMPORTED_MODULE_2__.formatDateYear)(dueDate),
    comments: (0,_comment_js__WEBPACK_IMPORTED_MODULE_0__.generateComments)(commentsCount),
    emojis,
    emojiImages,
    dueDate, 
    genres,
...
class Movies {
	...
	getFilms() {
    this._filmsByFilter = (0,_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__.getFilmsByFilter)(this._films, this._activeFilterType);

    return (0,_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__.getFilmsByFilter)(this._films, this._activeFilterType);
  }
...
/* harmony export */   "getRandomArrayLength2": () => (/* binding */ getRandomArrayLength2)
/* harmony export */ });
...
const getRandomArrayLength2 = (array) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "formatDateYear": () => (/* binding */ formatDateYear),
/* harmony export */   "formatDateFullDate": () => (/* binding */ formatDateFullDate),
/* harmony export */   "formatDuration": () => (/* binding */ formatDuration),
/* harmony export */   "formatDateHumanReadable": () => (/* binding */ formatDateHumanReadable)
/* harmony export */ });
...
const formatDateYear = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date(date)).format(`YYYY`);
};

const formatDateFullDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date(date)).format(`DD MMMM YYYY`);
};

const formatDuration = (durationMinutes) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default().unix(durationMinutes * 60).utc().format(`H[h] mm[m]`);
};

const formatDateHumanReadable = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date, `YYYY-MM-DDTHH:mm:ss.SSS-3`).fromNow();
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getWatchlistFilms": () => (/* binding */ getWatchlistFilms),
/* harmony export */   "getHistoryFilms": () => (/* binding */ getHistoryFilms),
/* harmony export */   "getFavoriteFilms": () => (/* binding */ getFavoriteFilms),
/* harmony export */   "getFilmsByFilter": () => (/* binding */ getFilmsByFilter)
/* harmony export */ });
...
/* harmony import */ var _controllers_page_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controllers/page.js */ "./src/controllers/page.js");
/* harmony import */ var _models_movies_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/movies.js */ "./src/models/movies.js");
/* harmony import */ var _mock_film_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mock/film.js */ "./src/mock/film.js");
/* harmony import */ var _mock_rank_user_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mock/rank-user.js */ "./src/mock/rank-user.js");
...
const rank = (0,_mock_rank_user_js__WEBPACK_IMPORTED_MODULE_8__.generateRank)();
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(headerElement, new _components_rank_user_js__WEBPACK_IMPORTED_MODULE_0__.default(rank));

const films = (0,_mock_film_js__WEBPACK_IMPORTED_MODULE_7__.generateFilms)(FILM_COUNT);
const filmsModel = new _models_movies_js__WEBPACK_IMPORTED_MODULE_6__.default();
filmsModel.setFilms(films);

const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_4__.default(mainElement, filmsModel);
filterController.render();

const sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_1__.default();
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(mainElement, sortComponent);

const filmsComponent = new _components_films_js__WEBPACK_IMPORTED_MODULE_2__.default();
const pageController = new _controllers_page_js__WEBPACK_IMPORTED_MODULE_5__.default(filmsComponent, filmsModel, sortComponent);

(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(mainElement, filmsComponent);
pageController.render(films);

(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_9__.render)(footerStatisticsElement, new _components_film_statistics_js__WEBPACK_IMPORTED_MODULE_3__.default(FILM_COUNT));
